/*  
======================================================
📌 RAW_WORD_DATA 안에 엑셀 복붙만 하면 자동 파싱됩니다.
======================================================
*/
...
1-4	cello	첼로	play the cello	첼로를 연주하다
...
1-6	plan	계획	the next plan	다음 계획
1-6	plant	식물, 심다	plant a flower	꽃을 심다
1-6	dish	접시, 요리	a clean dish	깨끗한 접시
1-6	wish	바라다	make a wish	소원을 빌다
1-6	cash	현금	by cash	현금으로
1-6	gas	가스	gas station	주유소

1-7	and	그리고	apples and grapes	사과와 포도
1-7	band	밴드, 악단	The band plays music.	밴드가 음악을 연주해.
1-7	hand	손	a right hand	오른손
1-7	sand	모래	a sandcastle	모래성
1-7	land	땅	the land and the sea	육지와 바다
1-7	gum	껌	bubble gum	풍선껌
1-7	album	앨범	an old album	오래된 앨범
1-7	drum	드럼	play the drums	드럼을 치다
1-7	camp	캠프, 캠핑하다	go camping	캠핑 가다
1-7	lamp	램프	They're lamps.	그것들은 전등이야.

1-8	back	등, 뒤로, 제자리로	Come back.	돌아와.
1-8	black	검은색	a black cat	검은색 고양이
1-8	rock	바위	rocks and stones	바위들과 돌멩이들
1-8	lock	잠그다	lock the door	문을 잠그다
1-8	block	막다, 블록	two blocks	두 개의 블록
1-8	clock	시계	a clock and a watch	시계와 손목시계
...
1-9	truck	트럭	a toy truck	장난감 트럭
1-9	track	선로	long train track	긴 기차선로
...
1-9	fast	빠른	run fast	빠르게 달리다
1-9	last	지난	last summer	지난여름

1-10	bank	은행	Where is the bank?	은행이 어디에 있어?
1-10	sink	싱크대, 가라앉다	in the bathroom	욕실에서
1-10	pink	분홍색	a pink pig	분홍색 돼지
1-10	milk	우유	chocolate milk	초콜릿 우유
1-10	wing	날개	four wings	날개 네 개
1-10	swing	그네	I like to swing.	나는 그네 타기를 좋아한다.
1-10	swim	수영하다	I can swim.	나는 수영을 할 수 있다.
1-10	gift	선물	a small gift	작은 선물
1-10	left	왼쪽	on your left	너의 왼쪽에
...
/*  
======================================================
📌  RAW_WORD_DATA → window.WORD_SETS
======================================================
*/
...
function parseWordData(raw) {
  ...
  for (const line of lines) {
    ...
    const [unit, word, meaning, exampleEn, exampleKo] = parts;
...
window.WORD_SETS = parseWordData(RAW_WORD_DATA);